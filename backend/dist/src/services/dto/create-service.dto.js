...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Corte masculino tradicional com máquina e tesoura' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 30, description: 'Duração em minutos' }),
    (0, class_validator_1.IsNumber)(),
