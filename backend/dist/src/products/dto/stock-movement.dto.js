...
exports.StockMovementDto = exports.StockMovementType = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: StockMovementType }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Reposição de estoque' }),
