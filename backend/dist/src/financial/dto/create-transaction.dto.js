...
exports.CreateTransactionDto = exports.TransactionCategory = exports.TransactionType = void 0;
...
(function (TransactionCategory) {
    TransactionCategory["SERVICE"] = "SERVICE";
    TransactionCategory["PRODUCT"] = "PRODUCT";
    TransactionCategory["PACKAGE"] = "PACKAGE";
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: TransactionCategory }),
    (0, class_validator_1.IsEnum)(TransactionCategory),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateTransactionDto.prototype, "category", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Pagamento de aluguel do mês' }),
