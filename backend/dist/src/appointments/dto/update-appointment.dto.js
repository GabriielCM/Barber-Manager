...
class UpdateAppointmentDto extends (0, swagger_2.PartialType)(create_appointment_dto_1.CreateAppointmentDto) {
}
exports.UpdateAppointmentDto = UpdateAppointmentDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: AppointmentStatus }),
